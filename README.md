...
| <a name="input_DOCKER_REPO_TAG"></a> [DOCKER\_REPO\_TAG](#input\_DOCKER\_REPO\_TAG)                                    | The repository branch/tag in DOCKER\_COMPOSITION\_REPO to use. Defaults to latest version tag.                                                              | `string` | `"1.7.3"`                                                        |    no    |
